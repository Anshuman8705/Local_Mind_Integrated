...
import { Button, Card, Chip, Empty, ErrorBanner, H1, H2, Input, Notice, P, Panel, Row, Screen, space } from "@/ui";
  ...
  return (
    <Screen>
      <Panel width={1000}>
        ...
        {/* Six fields in one column ran past the fold on a laptop, so the
            optional details sit two to a row. Name and email stay full width:
            they are the only required fields and the ones that carry the
            longest values. */}
